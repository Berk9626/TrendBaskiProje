...
{
    /// <inheritdoc />
    public partial class InitialTrendBaskiProjectDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SendingMessageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SendingMessages", x => x.SendingMessageId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserProfiles", x => x.AppUserProfileId);
                    table.ForeignKey(
                        name: "FK_AppUserProfiles_AspNetUsers_AppUserProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderBasket = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
